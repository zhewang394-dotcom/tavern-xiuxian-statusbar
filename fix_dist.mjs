...
function fixHtml(distHtmlPath) {
  ...
  console.log(`✅ ${distHtmlPath} 彻底清洗完成！`);
}

fixHtml('D:/AGENT/AI/秋青子/本格修仙_重构项目/05_GitHub开源分发仓库/tavern-xiuxian-statusbar/dist/修仙状态栏/index.html');
fixHtml('D:/AGENT/AI/秋青子/本格修仙_重构项目/05_GitHub开源分发仓库/tavern-xiuxian-statusbar/dist/自定义开局/index.html');
